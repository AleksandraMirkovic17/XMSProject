  ...
  <div>
    <div class="post-view">
      ...
      <div class="post-additiona" style="display: flex; flex-direction: row; width: 100%">
        ...
        <div>
          <button type="primary" class="btn-default" style="border: 0pt" data-bs-toggle="modal" :data-target="'#'+postid" v-on:click="changeSelectedPost">
            <div class="likes-icon">
...
export default {
  ...
  mounted: function () {
    ...
    PostService.getDislikes(this.postid)
        .then(response =>{
  ...
  methods:{
    ...
    deleteReaction(){
      ...
      PostService.deleteReaction(this.postid, JSON.parse(this.loggedUser).username )
          .then(()=>{
            this.changeSelectedPost()
          })
          .catch(err =>{
