...
type GenderAuth int32

const (
	GenderAuth_OtherAuth  GenderAuth = 0
	GenderAuth_MaleAuth   GenderAuth = 1
	GenderAuth_FemaleAuth GenderAuth = 2
)

// Enum value maps for GenderAuth.
var (
	GenderAuth_name = map[int32]string{
		0: "OtherAuth",
		1: "MaleAuth",
		2: "FemaleAuth",
	}
	GenderAuth_value = map[string]int32{
		"OtherAuth":  0,
		"MaleAuth":   1,
		"FemaleAuth": 2,
	}
...
func (x GenderAuth) Enum() *GenderAuth {
	p := new(GenderAuth)
	*p = x
	return p
}

func (x GenderAuth) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GenderAuth) Descriptor() protoreflect.EnumDescriptor {
	return file_authentication_service_proto_enumTypes[0].Descriptor()
}

func (GenderAuth) Type() protoreflect.EnumType {
	return &file_authentication_service_proto_enumTypes[0]
}

func (x GenderAuth) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GenderAuth.Descriptor instead.
func (GenderAuth) EnumDescriptor() ([]byte, []int) {
	return file_authentication_service_proto_rawDescGZIP(), []int{0}
}

type UserRoleAuth int32

const (
	UserRoleAuth_RegularAuth UserRoleAuth = 0
	UserRoleAuth_AdminAuth   UserRoleAuth = 1
	UserRoleAuth_AgentAuth   UserRoleAuth = 2
)

// Enum value maps for UserRoleAuth.
var (
	UserRoleAuth_name = map[int32]string{
		0: "RegularAuth",
		1: "AdminAuth",
		2: "AgentAuth",
	}
	UserRoleAuth_value = map[string]int32{
		"RegularAuth": 0,
		"AdminAuth":   1,
		"AgentAuth":   2,
	}
...
func (x UserRoleAuth) Enum() *UserRoleAuth {
	p := new(UserRoleAuth)
	*p = x
	return p
}

func (x UserRoleAuth) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (UserRoleAuth) Descriptor() protoreflect.EnumDescriptor {
	return file_authentication_service_proto_enumTypes[1].Descriptor()
}

func (UserRoleAuth) Type() protoreflect.EnumType {
	return &file_authentication_service_proto_enumTypes[1]
}

func (x UserRoleAuth) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use UserRoleAuth.Descriptor instead.
func (UserRoleAuth) EnumDescriptor() ([]byte, []int) {
...
type UserAuth struct {
	...
	Gender       GenderAuth   `protobuf:"varint,6,opt,name=gender,proto3,enum=GenderAuth" json:"gender,omitempty"`
	Role         UserRoleAuth `protobuf:"varint,7,opt,name=role,proto3,enum=UserRoleAuth" json:"role,omitempty"`
...
func (x *UserAuth) GetSurname() string {
	if x != nil {
		return x.Surname
	}
	return ""
...
func (x *UserAuth) GetGender() GenderAuth {
	if x != nil {
		return x.Gender
	}
	return GenderAuth_OtherAuth
}

func (x *UserAuth) GetRole() UserRoleAuth {
	if x != nil {
		return x.Role
	}
	return UserRoleAuth_RegularAuth
}

func (x *UserAuth) GetDateOfBirth() string {
	if x != nil {
...
func (x *UserAuth) GetPublic() bool {
	if x != nil {
		return x.Public
	}
	return false
...
func (x *UserAuth) GetContactPhone() string {
	if x != nil {
...
func (x *RegisterRequest) GetUser() *UserAuth {
	if x != nil {
		return x.User
	}
	return nil
...
var file_authentication_service_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x64, 0x22, 0xbc, 0x02, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x41, 0x75, 0x74, 0x68,
	...
	0x12, 0x23, 0x0a, 0x06, 0x67, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e,
	0x32, 0x0b, 0x2e, 0x47, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x41, 0x75, 0x74, 0x68, 0x52, 0x06, 0x67,
	0x65, 0x6e, 0x64, 0x65, 0x72, 0x12, 0x21, 0x0a, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x18, 0x07, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x6f, 0x6c, 0x65, 0x41, 0x75,
	0x74, 0x68, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x64, 0x61, 0x74, 0x65,
	...
	0x6e, 0x65, 0x22, 0x4d, 0x0a, 0x05, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x72,
	...
	0x6e, 0x22, 0x3e, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x2e, 0x0a, 0x0b, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x73,
	...
	0x73, 0x22, 0x30, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x1d, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x09, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x41, 0x75, 0x74, 0x68, 0x52, 0x04, 0x75,
	0x73, 0x65, 0x72, 0x22, 0x74, 0x0a, 0x10, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52,
	...
	,
	...
	0x02, 0x11, 0x22, 0x09, 0x2f, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x3a, 0x04, 0x75,
	0x73, 0x65, 0x72, 0x12, 0x5c, 0x0a, 0x0c, 0x49, 0x73, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69,
	0x7a, 0x65, 0x64, 0x12, 0x15, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x41, 0x75, 0x74,
	...
	0x6e, 0x42, 0x16, 0x5a, 0x14, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
...
var file_authentication_service_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_authentication_service_proto_goTypes = []interface{}{
	(GenderAuth)(0),               // 0: GenderAuth
	(UserRoleAuth)(0),             // 1: UserRoleAuth
	(*Credentials)(nil),           // 2: Credentials
	(*UserAuth)(nil),              // 3: UserAuth
	(*Token)(nil),                 // 4: Token
	(*LoginRequest)(nil),          // 5: LoginRequest
	(*RegisterRequest)(nil),       // 6: RegisterRequest
	(*RegisterResponse)(nil),      // 7: RegisterResponse
	(*AuthorizationRequest)(nil),  // 8: AuthorizationRequest
	(*AuthorizationResponse)(nil), // 9: AuthorizationResponse
}
var file_authentication_service_proto_depIdxs = []int32{
	0, // 0: UserAuth.gender:type_name -> GenderAuth
	1, // 1: UserAuth.role:type_name -> UserRoleAuth
	2, // 2: LoginRequest.credentials:type_name -> Credentials
	3, // 3: RegisterRequest.user:type_name -> UserAuth
	4, // 4: AuthorizationRequest.token:type_name -> Token
	5, // 5: AuthenticationService.Login:input_type -> LoginRequest
	6, // 6: AuthenticationService.Register:input_type -> RegisterRequest
	8, // 7: AuthenticationService.IsAuthorized:input_type -> AuthorizationRequest
	4, // 8: AuthenticationService.Login:output_type -> Token
	7, // 9: AuthenticationService.Register:output_type -> RegisterResponse
	9, // 10: AuthenticationService.IsAuthorized:output_type -> AuthorizationResponse
