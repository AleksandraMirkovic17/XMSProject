...
func MapUser(user *domain.User) *pb.User {
	var userPb = &pb.User{
		...
		NotificationsFollowedProfiles: user.NotificationsFollowedProfiles,
		NotificationsPosts:            user.NotificationsPosts,
		NotificationsMessages:         user.NotificationsMessages,
	}
...
func MapUserPbToDomain(userPb *pb.User) *domain.User {
	...
	userD := &domain.User{
		...
		NotificationsFollowedProfiles: (*userPb).NotificationsFollowedProfiles,
		NotificationsPosts:            (*userPb).NotificationsPosts,
		NotificationsMessages:         (*userPb).NotificationsMessages,
	}
